...
public class Point {
    ...
    public void render() {
        ...
        AxisAlignedBB aabb = AxisAlignedBB.getBoundingBox((double) this.coord.posX, (double) this.coord.posY, (double) this.coord.posZ, (double) this.coord.posX + 1.0D, (double) this.coord.posY + 1.0D, (double) this.coord.posZ + 1.0D).expand(0.02D, 0.02D, 0.02D);
